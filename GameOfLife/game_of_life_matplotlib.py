...
Usage:
    game_of_life_matplotlib.py [options]
...
Created 01/06/2021 at 21:32 GMT
...
def animate(i, axes):
    ...
    first_child = axes.get_children()[0]
    if isinstance(first_child, matplotlib.collections.PathCollection):
        first_child.remove()
